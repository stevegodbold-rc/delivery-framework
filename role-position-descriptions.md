# Position Descriptions: Delivery Director, Practice Lead, Resource Manager

These position descriptions are derived directly from the responsibilities, decision rights, metrics ownership, and standing cadences assigned to each role across the Delivery Management Framework (Stage 1 through Stage 4, and Delivery Portfolio Management). Where the framework does not specify a formal reporting line, this is noted rather than invented — the framework defines what each role is accountable for, not an organisation chart.
...
- Engagements in Recovery and Exception status; days in Recovery and Exception status
- Active engagements per Delivery Owner; Delivery Owner engagement load vs. WIP ceiling
- Lead time: close to start (p50/p85)
- Revenue at risk (Amber/Red); average days from Red commercial health flag to billing milestone resolution
...
Owns workforce capability, skills strategy, and delivery quality support across the practice. Acts as the bridge between individual engagement delivery and the organisation's longer-term skilling, hiring, and knowledge-reuse position.

**Reports to:** Not specified by the framework — typically practice or capability leadership.
...
**Success Measures (owned or co-owned)**
- % of engagements with completed Handover Record before kickoff
- Skilling gaps identified vs. resolved
- T-shape density as % of population; core skill population as % of total; deal types with high delivery alignment as % of pipeline
- Open requisitions vs. WIP limit, by practice area; requisitions aged beyond calibrated benchmark, by seniority band
- Retrospective completion rate; knowledge base entry completion rate
...
Owns capacity and allocation data across the delivery workforce. Manages the practical mechanics of getting the right people onto the right engagements, keeping bench time and resource gaps visible and moving rather than left to accumulate.

**Reports to:** Not specified by the framework — typically resourcing or delivery operations leadership.

**Key Responsibilities**

*Allocation and utilisation*
- Manages allocation across engagements and surfaces utilisation risk
- Reviews elasticity signals monthly at the Workforce Review: unresolved resource gaps, practitioners on bench for more than 10 business days, skills required but not held, and certifications appearing in bids but not in the team
- Does not reallocate a practitioner without a direct conversation with their Delivery Owner and the individual concerned
...
- Owns the bench queue: tracks bench count as a % of total delivery headcount, read alongside Remaining Capacity — if the bench queue consistently outgrows what Remaining Capacity was sized to absorb, that is read as a signal to resize the buffer, not a signal about individual practitioners
- Tracks bench time by individual against the 10-business-day threshold

*Closure*
- Confirms each practitioner's next allocation at least 10 business days before an engagement closes, jointly with the Delivery Owner — no practitioner should reach their last day without knowing what's next
- Confirms timesheet submission compliance at engagement close

**Decision Rights**
- Sets the Remaining Capacity buffer threshold
- Escalates resource gaps beyond the 10-business-day aging threshold to the Practice Lead

**Success Measures (owned or co-owned)**
- Available hours; scheduled hours; remaining capacity
- Lead time: advertise to ready (p50/p85)
- Billable utilisation (rolling 4-week); bench time by practitioner; time to fill open resource gaps
- Resource gap queue length; resource gaps aged beyond 10 business days; bench queue as % of total delivery headcount
- Practitioner transition lead time (% with confirmed next allocation 10+ days before closure)
- Timesheet submission compliance at close
...
*Note on structure:* the framework describes these as accountability and decision-rights roles, not a fixed organisational hierarchy or headcount model. At smaller scale, one person may hold more than one of these roles; at larger scale (per the framework's own operating range), each is likely to be a distinct position, and the Delivery Director role in particular may need to delegate the chairing load across sub-portfolios rather than remain a single point of coordination across the whole business.
